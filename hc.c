 ...
 */
const char *hc_names[][4] = {
  {"ans","func","Functions/Misc","last result"},
  ...
  {"boxplot","func:[v_1,v_2,...,v_n]","Stats","draws a boxplot of values v_1...v_n"},
  {"cbrt","func:x","Functions/Math","cube root of x (=x^(1/3))"},
  {"ceil","func:x","Functions/Math","rounds x up to nearest integer"},
  {"chartocode","func:x","Conversions","converts a character to its ASCII code"},
  {"clear","func:var","Functions/Misc","clears a variable var"},
  {"cmtoinch","func:x","Conversions","converts centimeters to inches"},
  {"codetochar","func:x","Conversions","converts an ASCII code to a character"},
  {"cos","func:x","Functions/Trigonometry","cosine of x"},
  {"cosh","func:x","Functions/Trigonometry","hyperbolic cosine of x"},
  {"crossp","func:a,b","Functions/Vectors","vector cross product - a X b"},
  {"ctof","func:x","Conversions","converts d. Celsius to d. Fahrenheit"},
  {"ctok","func:x","Conversions","converts d. Celsius to Kelvin"},
  {"dotp","func:a,b","Functions/Vectors","vector dot product - a . b"},
  {"exp","func:x","Functions/Math","exponential function"},
  {"factorial","func:x","Functions/Math","factorial of x (=x!)"},
  ...
  {"floztoml","func:x","Conversions","converts US fluid ounces to mililiters"},
  {"for","func:init,condition,iter,body","Programming","evaluates init, then body while condition is true, evaluating iter each iteration"},
  {"ftoc","func:x","Conversions","converts d. Fahrenheit to d. Celsius"},
  {"ftok","func:x","Conversions","converts d. Fahrenheit to Kelvin"},
  {"fttom","func:x","Conversions","converts feet to meters"},
  {"gcd","func:x,y","Functions/Math","greatest common denominator of x and y"},
  {"graph","func:expr,xmin,xmax,ymin,ymax","Graphs","draw a 2D graph. xmin,...,ymax are optional"},
  {"graphpeq","func:expr_x,expr_y,tmin,tmax,xmin,xmax,ymin,ymax","Graphs","draw a parametric graph. tmin,...,ymax are optional"},
  {"graphv","func","#",""},
  ...
  {"inchtocm","func:x","Conversions","converts inches to centimeters"},
  {"input","func:str","Functions/Misc","ask the user for a value, using str as prompt"},
  {"join","func:a,b","Functions/Misc","join (concatenate) a and b"},
  {"kgtolbs","func:x","Conversions","converts kilograms to pounds"},
  {"kmtomi","func:x","Conversions","converts kilometers to miles"},
  {"ktoc","func:x","Conversions","converts Kelvin to d. Celsius"},
  {"ktof","func:x","Conversions","converts Kelvin to d. Fahrenheit"},
  {"lbstokg","func:x","Conversions","converts pounds to kilograms"},
  {"lcm","func:x,y","Functions/Math","least common multiple of x and y"},
  {"length","func:x","Functions/Misc","length of x"},
  {"linreg","func:[v_1,v_2,...,v_n]","Stats","returns slope and y-intercept of best-fit line through v_1,...,v_n"},
  {"ln","func:x","Functions/Math","natural logarithm of x"},
  {"log10","func:x","Functions/Math","common logarithm of x"},
  {"map","func:f,list","Programming","maps f to each element in list"},
  {"mitokm","func:x","Conversions","converts miles to kilometers"},
  {"mltofloz","func:x","Conversions","converts mililiters to US fluid ounces"},
  {"mmass","func:str","Functions/Chemistry","molar mass of molecules - see help(\"mmass\")"},
  {"mod","func:x,y","Functions/Math","modulo division (=x%y)"},
  {"mtoft","func:x","Conversions","converts meters to feet"},
  {"nCr","func:n,k","Functions/Combinatorics","binomial coefficient"},
  {"nPr","func:n,k","Functions/Combinatorics","number of permutations"},
  {"num","func:str","Functions/Misc","number representation of string str"},
  {"ones","func:n","Functions/Misc","returns an array containing n ones"},
  {"print","func:element_1,element_2,...,element_n","Functions/Misc","prints out its arguments"},
  {"product","func:expr,low,high","Functions/Math","\"big Pi\" product with x as the variable"},
  {"rand","func:n","Functions/Misc","if n is specified, returns a random integer in [1;n]; otherwise returns a real in [0;1["},
  {"range","func:a,b","Functions/Misc","if a is specified, list with integers from a (included) to b (not included); if not, from 0 (included) to b (not included)"},
  {"re","func:x","#",""},
  {"real","func:x","Functions/Misc","real part of x"},
  {"round","func:x","Functions/Math","round x to nearest integer (away from zero for .5 cases)"},
  {"sin","func:x","Functions/Trigonometry","sine of x"},
  {"sinh","func:x","Functions/Trigonometry","hyperbolic sine of x"},
  {"slpfld","func:expr,xmin,xmax,ymin,ymax","Graphs","draw a slope field of dy/dx = expr"},
  {"sort","func:list,cmpfunction","Functions/Misc","sort list - see help(\"sort\")"},
  {"sqrt","func:x","Functions/Math","square root of x"},
  {"stats","func:[v_1,v_2,...,v_n]","Stats","stats info for v_1,...,v_n"},
  {"str","func:num","Functions/Misc","string representation of num"},
  {"sum","func:expr,low,high","Functions/Math","\"sigma sum\" with x as the variable"},
  {"tan","func:x","Functions/Trigonometry","tangent of x"},
  {"tanh","func:x","Functions/Trigonometry","hyperbolic tangent of x"},
  {"totient","func:x","Functions/Math","Euler's totient of x"},
  {"while","func:condition,body","Programming","evaluates body while condition is true"},
  {"write","func:filename,element_1,element_2,...,element_n","Functions/Misc","same as print, but writes to file specified with filename"},
  {"zeros","func:n","Functions/Misc","returns an array containing n zeros"},
  // CONSTANTS
