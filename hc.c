...
const char *hc_names[][3] = {
  {"ans","func","Functions/Misc"},
  {"abs","func","Functions/Math"},
  {"acos","func","Functions/Trigonometry"},
  {"asin","func","Functions/Trigonometry"},
  {"atan","func","Functions/Trigonometry"},
  {"boxplot","func","Stats"},
  {"cbrt","func","Functions/Math"},
  {"ceil","func","Functions/Math"},
  {"chartocode","func","Conversions"},
  {"clear","func","Functions/Misc"},
  {"cmtoinch","func","Conversions"},
  {"codetochar","func","Conversions"},
  {"cos","func","Functions/Trigonometry"},
  {"cosh","func","Functions/Trigonometry"},
  {"crossp","func","Functions/Vectors"},
  {"ctof","func","Conversions"},
  {"ctok","func","Conversions"},
  {"dotp","func","Functions/Vectors"},
  {"exp","func","Functions/Math"},
  {"factorial","func","Functions/Math"},
  {"fibo","func","Functions/Math"},
  {"floor","func","Functions/Math"},
  {"floztoml","func","Conversions"},
  {"for","func","Programming"},
  {"ftoc","func","Conversions"},
  {"ftok","func","Conversions"},
  {"fttom","func","Conversions"},
  {"gcd","func","Functions/Math"},
  {"graph","func","Graphs"},
  {"graphpeq","func","Graphs"},
  {"graphv","func","#"},
  {"graphvalues","func","Graphs"},
  {"gmul","func","Graphs"},
  {"graph3","func","Graphs"},
  {"help","func","#"},
  {"if","func","Programming"},
  {"im","func","#"},
  {"imag","func","Functions/Math"},
  {"inchtocm","func","Conversions"},
  {"input","func","Functions/Misc"},
  {"join","func","Functions/Misc"},
  {"kgtolbs","func","Conversions"},
  {"kmtomi","func","Conversions"},
  {"ktoc","func","Conversions"},
  {"ktof","func","Conversions"},
  {"lbstokg","func","Conversions"},
  {"lcm","func","Functions/Math"},
  {"length","func","Functions/Misc"},
  {"linreg","func","Stats"},
  {"ln","func","Functions/Math"},
  {"log10","func","Functions/Math"},
  {"map","func","Programming"},
  {"mitokm","func","Conversions"},
  {"mltofloz","func","Conversions"},
  {"mmass","func","Functions/Chemistry"},
  {"mod","func","Functions/Math"},
  {"mtoft","func","Conversions"},
  {"nCr","func","Functions/Combinatorics"},
  {"nPr","func","Functions/Combinatorics"},
  {"num","func","Functions/Misc"},
  {"ones","func","Functions/Misc"},
  {"print","func","Functions/Misc"},
  {"product","func","Functions/Math"},
  {"rand","func","Functions/Misc"},
  {"range","func","Functions/Misc"},
  {"re","func","#"},
  {"real","func","Functions/Misc"},
  {"round","func","Functions/Math"},
  {"sin","func","Functions/Trigonometry"},
  {"sinh","func","Functions/Trigonometry"},
  {"slpfld","func","Graphs"},
  {"sort","func","Functions/Misc"},
  {"sqrt","func","Functions/Math"},
  {"stats","func","Stats"},
  {"str","func","Functions/Misc"},
  {"sum","func","Functions/Math"},
  {"tan","func","Functions/Trigonometry"},
  {"tanh","func","Functions/Trigonometry"},
  {"totient","func","Functions/Math"},
  {"while","func","Programming"},
  {"write","func","Functions/Misc"},
  {"zeros","func","Functions/Misc"},
  // CONSTANTS
  {"pi","cnst:3.14159265358979323846264338327950288419716939937510582097494459230781640628620899862803482534211706798214808651328230664709384461","Constants"},
  {"c","cnst:299792458","Constants"},
  {"e","cnst:2.7182818284590452353602874713526624977572470936999595749669676277240766303535475945713821785251664274274663919320030599218174136","Constants"},
  {"phi","cnst:1.61803398874989484820458683436563811772030917980576286213544862270526046281890244970720720418939113748475408807538689175212663386","Constants"},
  {"g","cnst:9.80655","Constants"},
  {"answer","cnst:42","Constants"},
  {"na","cnst:6.0221415e23","Constants"},
  // OTHERS
  {"help","cmd","#"},
  {"credits","cmd","#"},
  {"i","sys","#"},
