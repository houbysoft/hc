...
const char *hc_names[][5] = {
  ...
  {"cmtoinch","func:x","Conversions","converts centimeters to inches","converts x, which has to be in cm, to inches"},
  ...
  {"graphv","func","#","","see help for graphvalues()"},
  ...
  {"inchtocm","func:x","Conversions","converts inches to centimeters","converts x, which has to be in inches, to cm"},
  ...
  {"kgtolbs","func:x","Conversions","converts kilograms to pounds","converts x, which has to be in kilograms, to pounds"},
  {"kmtomi","func:x","Conversions","converts kilometers to miles","converts x, which has to be in km, to miles"},
  {"ktoc","func:x","Conversions","converts Kelvin to d. Celsius","converts x, which has to be in Kelvin, to degrees Celsius"},
  {"ktof","func:x","Conversions","converts Kelvin to d. Fahrenheit","converts x, which has to be in Kelvin, to Fahrenheit"},
  {"lbstokg","func:x","Conversions","converts pounds to kilograms","converts x, which has to be in pounds, to kilograms"},
  ...
  {"mltofloz","func:x","Conversions","converts mililiters to US fluid ounces","converts x, which has to be in ml, to US fluid ounces"},
  ...
  {"mtoft","func:x","Conversions","converts meters to feet","converts x, which has to be in meters, to feet"},
