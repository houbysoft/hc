...
#define HC_NAMES_CNST_START 69 // first field with a constant in the hc_names array
#define HC_NAMES_CNST_STOP 74 // last field with a constant in the hc_names array
