...
#define HC_NAMES 99 // number of fields in the hc_names array
#define HC_NAMES_CNST_START 70 // first field with a constant in the hc_names array
#define HC_NAMES_CNST_STOP 75 // last field with a constant in the hc_names array
