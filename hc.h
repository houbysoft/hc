...
#define HC_NAMES 100 // number of fields in the hc_names array
#define HC_NAMES_CNST_START 78 // first field with a constant in the hc_names array
#define HC_NAMES_CNST_STOP 84 // last field with a constant in the hc_names array
